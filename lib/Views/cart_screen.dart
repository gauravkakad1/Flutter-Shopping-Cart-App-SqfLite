                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      SizedBox(
                                          ...
                                          child: ClipRect(child: Image.network(snapshot.data![index].image.toString()),)
                                      ),
                                      SizedBox(width: 20,),
                                      Expanded(
                                        child: Column(
                                                        ...
                                                        children: [
                                                          InkWell(child: Icon(Icons.remove,color: Colors.white,),
                                                            onTap:() {
                                                              ...
                                                              quantity--;
                                                              int newPrice = quantity*initialPrice;
                                                              if(quantity>0){
                                                          ...
                                                          Text(snapshot.data![index].quantity.toString(),style: TextStyle(color: Colors.white,fontSize:18,fontWeight: FontWeight.bold),),
                ...
                child: Consumer<CartProvider>(
                    builder: (context, value, child) {
                      ...
                      return  Visibility(
                        ...
                        child: Column(
                          children: [
                            ReusableWidget(title: 'Subtotal', value: r'$'+subTotalPrice.toStringAsFixed(2)),
                            ReusableWidget(title: 'Discount', value: r'$'+disCount.toStringAsFixed(2)),
                            ReusableWidget(title: 'Total', value: r'$'+toTalPrice.toStringAsFixed(2)),
                            Container(
                              height: 50,
                              width: 200,
                              child: Center(
                                child: Text(
                                  "Pay Now" , style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20,color: Colors.black,),
                                ),
                              ),
